...
import { useCartStore } from "@/src/components/store/cartStore"; // تأكد من مسار الـ Store
import { toast } from "sonner";

// 1. تحديث الـ Interface ليتطابق مع استجابة الباك إند بالكامل
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col justify-center space-y-6">
          ...
          <div className="pt-2">
            <Button
              size="lg"
              className="w-full md:w-2/3 rounded-xl flex items-center gap-2 h-14 text-lg"
